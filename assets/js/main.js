...
var typingEffect = new Typed(".typedText",{
  strings : ["Java Coder","Backend Developer"],
  loop : true,
  typeSpeed : 100, 
  backSpeed : 80,
  backDelay : 2000
...
function UpdateTheme(flag){
  ...
  if (flag){
    ...
    document.documentElement.style.setProperty('--text-color-third','rgb(255, 174, 76)')
    document.documentElement.style.setProperty('--text-color-fourth','rgb(255, 170, 100)')
    ...
    document.documentElement.style.setProperty('--first-color-hover','rgb(212, 170, 110)')
    document.documentElement.style.setProperty('--first-shadow-color','rgba(255, 255, 255, 0.25)')
    ...
    document.documentElement.style.setProperty('--border-color', 'rgb(160, 160, 160)')
  }
}
